...
public class Cod_Input extends AppCompatActivity {
    EditText r_name,r_phone,name,phone,area,address,d_area,d_address,instruction,cod;
    Spinner weight;
    RadioButton liq,fri;
    Button enter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cod__input);

        pd=new ProgressDialog(Cod_Input.this);
        ...
        cod=findViewById(R.id.conbdtET);
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.getText().toString().isEmpty() || phone.getText().toString().isEmpty() || area.getText().toString().isEmpty()
                        ...
                        area.getText().toString().isEmpty() || cod.getText().toString().isEmpty()){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Post_Model post_model = new Post_Model(u,"null","null","null","Agent will come to pickup",a,r_name.getText().toString(),r_phone.getText().toString(),
                            formattedDate,"nulls",pids,"null","null","Cash on Delivery",uuid,String.valueOf(time),
                            ...
                            instruction.getText().toString(),c,b,"null","null","null",cod.getText().toString());
